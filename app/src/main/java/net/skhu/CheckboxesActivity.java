...
public class CheckboxesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CompoundButton.OnCheckedChangeListener listener1 = new CompoundButton.OnCheckedChangeListener() {   //compoundbotton에 대한 listener
           @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {    //체크상태가 변경되면
        ...
        RadioGroup.OnCheckedChangeListener listener2 = new RadioGroup.OnCheckedChangeListener() {   //radiobutton에 다한 listener
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) { //checkedId는 현재 체크된 체크박스의 id
        ...
        Button button = (Button)findViewById(R.id.btnSave); //해당 id를 찾지못할경우 오류 발생
        button.setOnClickListener(new View.OnClickListener() { //버튼 전용이 아닌 모든 view의 공용 onclicklistener
            @Override
            public void onClick(View v) {
                String s = "checkBox1=" + checkBox1.isChecked() + " ";  //final 지역변수는 호출가능
